...
function Write() {
  ...
  return (
    <div className="h-[calc(100%]vh -v64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6">
      ...
      <form action="" className="flex flex-col gap-6 flex-1 mb-6">
        ...
        />
        <button className="rounded-xl bg-blue-800 text-white p-2   w-36 shadow-md font-medium">
          send
        </button>
      </form>
    </div>
